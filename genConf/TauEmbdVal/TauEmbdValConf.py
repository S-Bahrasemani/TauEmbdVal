#Mon Jun 29 10:07:14 2015"""Automatically generated. DO NOT EDIT please"""
from GaudiKernel.GaudiHandles import *
from GaudiKernel.Proxy.Configurable import *

class TauEmbdValAlg( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(TauEmbdValAlg, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'TauEmbdVal'
  def getType( self ):
      return 'TauEmbdValAlg'
  pass # class TauEmbdValAlg
